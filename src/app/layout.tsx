...
export const metadata: Metadata = {
  title: "Joel's Chicken Self-Ordering Kiosk",  description: "Order fresh, crispy fried chicken instantly at Joel's Chicken self-service kiosk. Quick, convenient, and delicious meals prepared to order.",  keywords: "fast food ordering, chicken restaurant, self-service kiosk, quick lunch, fried chicken",  openGraph: {
    title: "Joel's Chicken Self-Ordering Kiosk",    description: "Order your favorite chicken meals in seconds with our innovative self-ordering kiosk system.",    siteName: "Joel's Chicken",    type: "website"},
};
